...
BasicGame.Game.prototype = {
  ...
  setupBullets: function () {
    ...
    // Add an empty sprite group into our
    this.bulletPool = this.add.group();
    ...
    // Add 100 'bullet' sprites in group.
    // By default this use the first frame of the sprite sheet and
    ...
    // Automatically kill the bullet sprite when they go out of bounds
  ...
  addToScore: function (score) {
    ...
    // this approach prevents the boss from spawning againupon winning
  ...
  explode: function (sprite) {
    ...
    // add the orignal sprite's velocity to the explosion
  ...
  fire: function() {
    ...
    if (this.weaponLevel === 0) {
      ...
      for (var i = 0; i < this.weaponLevel; i++) {
        bullet = this.bulletPool.getFirstExists(false);
        // spawn left bulletPool.getFirstExists(false);
        ...
        bullet.reset(this.player.x + (10 + i * 6), this.player.y - 20);
        // the right bullet spread from -85 degrees to -45
        this.physics.arcade.velocityFromAngle(
